...
public class FilterDispatcher implements Filter {
    ...
    private final String homePage = "GetProductController";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.length() > 0) {
                ...
                if (resource.lastIndexOf(".jpg") > 0 || resource.lastIndexOf(".png") > 0 || resource.lastIndexOf(".css") > 0 || resource.lastIndexOf(".js") > 0) {
                    url = resource;
                }
            }
            if (url != null) {
